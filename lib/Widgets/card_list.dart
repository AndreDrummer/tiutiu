...
class _CardListState extends State<CardList> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, Routes.PET_DETAILS, arguments: widget.petInfo);
      },
      child: Padding(
          padding: const EdgeInsets.all(4.0),
          child: FutureBuilder(
              future: calculateDistance(widget.petInfo.toMap()['latitude'],
                  widget.petInfo.toMap()['longitude']),
              builder: (_, snapshot) {
