...
class FavoritesProvider with ChangeNotifier {
  ...
  Stream<List<QueryDocumentSnapshot>> get favoritesListReference =>
      _favoritesListReference.stream;
  void Function(List<QueryDocumentSnapshot>) get changefavoritesListReference =>
      _favoritesListReference.sink.add;
  List<QueryDocumentSnapshot> get getFavoritesListReference =>
      _favoritesListReference.value;

  Stream<List<Pet>> get favoritesPETSList => _favoritesPETSList.stream;
  void Function(List<Pet>) get changeFavoritesPETSList =>
      _favoritesPETSList.sink.add;
  ...
  void Function(List<String>) get changeFavoritesPETSIDList =>
      _favoritesPETSIDList.sink.add;
  ...
  Future<void> loadPETsFavorites() async {
    ...
    for (int i = 0; i < getFavoritesListReference.length; i++) {
      DocumentSnapshot pet = await ((getFavoritesListReference[i].data()
