...
class AdminRemoteConfig {
  ...
  AdminRemoteConfig fromSnapshot(DocumentSnapshot snapshot) {
    return AdminRemoteConfig(
      ...
      appInstagramUser: snapshot.get(AdminRemoteConfigEnum.appInstagramUser.name),
      allowAdOnOpening: snapshot.get(AdminRemoteConfigEnum.allowAdOnOpening.name),
      appFacebookUser: snapshot.get(AdminRemoteConfigEnum.appFacebookUser.name),
      ...
      appTikTokUser: snapshot.get(AdminRemoteConfigEnum.appTikTokUser.name),
      appTikTokLink: snapshot.get(AdminRemoteConfigEnum.appTikTokLink.name),
